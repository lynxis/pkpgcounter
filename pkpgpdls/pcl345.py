...
class Parser(pdlparser.PDLParser) :
    ...
    def isValid(self) :    
        ...
        if self.parent.firstblock.startswith("\033E\033") or \
           (self.parent.firstblock.startswith("\033*rbC") and (not self.parent.lastblock[-3:] == "\f\033@")) or \
           self.parent.firstblock.startswith("\033*rB\033") or \
           self.parent.firstblock.startswith("\033%8\033") or \
           (self.parent.firstblock.find("\033%-12345X") != -1) or \
           (self.parent.firstblock.find("@PJL ENTER LANGUAGE=PCL\012\015\033") != -1) or \
           (self.parent.firstblock.startswith(chr(0xcd)+chr(0xca)) and (self.parent.firstblock.find("\033E\033") != -1)) :
