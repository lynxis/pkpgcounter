...
from pdlanalyzer.postscript import PostScriptParser
from pdlanalyzer.pdf import PDFParser
from pdlanalyzer.pcl345 import PCL345Parser
from pdlanalyzer.pclxl import PCLXLParser
from pdlanalyzer.escp2 import ESCP2Parser
...
class PDLAnalyzer :    
    ...
    def __init__(self, filename, debug=0) :
        ...
        try :
            ...
            psyco.bind(PDFParser.getJobSize)
            psyco.bind(ESCP2Parser.getJobSize)
            psyco.bind(PCLParser.getJobSize)
            psyco.bind(PCLXLParser.getJobSize)
    ...
    def getJobSize(self) :    
        ...
        try :
            ...
            self.closeFile()
            raise PDLParserError, "ERROR : Unknown file format for %s (%s)" % (self.filename, msg)
        else :
            try :
    ...
    def detectPDLHandler(self) :    
        ...
        if self.isPostScript(firstblock, lastblock) :
            ...
            raise PDLParserError, "Analysis of first data block failed."
